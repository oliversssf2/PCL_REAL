...
namespace ImGui {
	...
	*
	...
	IMGUI_API bool FocusableItemRegister(ImGuiWindow * window, bool
	is_active,
	bool tab_stop = true
...
IMGUI_API bool SliderBehavior(const ImRect &frame_bb, ImGuiID id, float *v, float v_min, float v_max, float power,
                              int decimal_precision, ImGuiSliderFlags flags = 0, bool render_bg = false);
...
IMGUI_API bool
DragIntN(const char *label, int *v, int components, float v_speed, int v_min, int v_max, const char *display_format);
